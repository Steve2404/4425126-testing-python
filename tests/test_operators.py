...
def test_addition_should_return_none_with_wrong_operator():
    sut = Operators()
    operation = "5.5 * 10"
    assert sut.addition(operation) is None
...
def test_substraction_should_return_none_with_wrong_operator():
    sut = Operators()
    operation = "5.5 * 10"
    assert sut.substraction(operation) is None
...
def test_multiplication_should_return_none_with_wrong_operator():
    sut = Operators()
    operation = "5.5 / 10"
    assert sut.multiplication(operation) is None
...
def test_division_should_return_none_with_wrong_operator():
    sut = Operators()
    operation = "5.5 * 10"
    assert sut.division(operation) is None
